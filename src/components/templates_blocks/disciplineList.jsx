    ...
    <div>
      <section className='my-12 w-full lg:mx-0 xl:pe-8 2xl:mx-0  max-w-full'>
        ...
        <div className='flex flex-wrap gap-x-4 gap-y-4 justify-center xl:justify-between my-6 font-medium w-full mx-auto xl:gap-y-6'>
          ...
          <Link to='/coursefinder?country=Where?&name=&discipline=computer-science' state={{ slug: 'computer-science' }} onMouseOver={() => setIsHovDiscipline13(true)} onMouseOut={() => setIsHovDiscipline13(false)}>
            {isHovDiscipline13
              ? <div className='flex flex-col items-center justify-center w-32 xs:w-36  2xs:w-40 border-2 border-border_white md:w-52 lg:w-36 xl:w-48 h-36 bg-white deepShadow rounded-lg'>
                <div className=' p-2 w-32 lg:w-fit '>
                  <div className=' bg-yellow p-2 w-fit rounded-full mx-auto'>
                  ...
                  <div className='font-semibold text-sm my-2 text-center'>Computer Science</div>
                </div>
                </div>
              : <div className='flex flex-col items-center justify-center w-32 xs:w-36  2xs:w-40 md:w-52 lg:w-36 xl:w-48 h-36 bg-white shadow-2 rounded-lg'>
                <div className=' p-2 w-32 lg:w-fit '>
          ...
          <Link to='/coursefinder?country=Where?&name=&discipline=medicine' state={{ slug: 'medicine' }} onMouseOver={() => setIsHovDiscipline14(true)} onMouseOut={() => setIsHovDiscipline14(false)}>
            {isHovDiscipline14
              ? <div className='flex flex-col items-center justify-center w-32 xs:w-36  2xs:w-40 border-2 border-border_white md:w-52 lg:w-36 xl:w-48 h-36 bg-white deepShadow rounded-lg'>
                <div className=' p-2 w-32 lg:w-fit '>
                  <div className=' bg-green p-2 w-fit rounded-full mx-auto'>
                  ...
                  <div className='font-semibold text-sm my-2 text-center'>Medicine</div>
                </div>
                </div>
              : <div className='flex flex-col items-center justify-center w-32 xs:w-36  2xs:w-40 md:w-52 lg:w-36 xl:w-48 h-36 bg-white shadow-2 rounded-lg'>
                <div className=' p-2 w-32 lg:w-fit '>
          ...
          <Link to='/coursefinder?country=Where?&name=&discipline=psychology' state={{ slug: 'psychology' }} onMouseOver={() => setIsHovDiscipline15(true)} onMouseOut={() => setIsHovDiscipline15(false)}>
            {isHovDiscipline15
              ? <div className='flex flex-col items-center justify-center w-32 xs:w-36  2xs:w-40 border-2 border-border_white md:w-52 lg:w-36 xl:w-48 h-36 bg-white deepShadow rounded-lg'>
                <div className=' p-2 w-32 lg:w-fit '>
                  <div className=' bg-deep_blue p-2 w-fit rounded-full mx-auto'>
                  ...
                  <div className='font-semibold text-sm my-2 text-center'>Psychology</div>
                </div>
                </div>
              : <div className='flex flex-col items-center justify-center w-32 xs:w-36  2xs:w-40 md:w-52 lg:w-36 xl:w-48 h-36 bg-white shadow-2 rounded-lg'>
                <div className=' p-2 w-32 lg:w-fit '>
                  <div className=' bg-blue p-2 w-fit rounded-full mx-auto bg-opacity-10'>
                    <div className='text-3xl  flex text-deep_blue justify-center p-1'>
                        <BsCloudSunFill />
                      </div>
                  </div>
          ...
          <Link to='/coursefinder?country=Where?&name=&discipline=humanities' state={{ slug: 'humanities' }} onMouseOver={() => setIsHovDiscipline16(true)} onMouseOut={() => setIsHovDiscipline16(false)}>
            {isHovDiscipline16
              ? <div className='flex flex-col items-center justify-center w-32 xs:w-36  2xs:w-40 border-2 border-border_white md:w-52 lg:w-36 xl:w-48 h-36 bg-white deepShadow rounded-lg'>
                <div className=' p-2 w-32 lg:w-fit '>
                  <div className=' bg-red p-2 w-fit rounded-full mx-auto'>
                    <div className='text-3xl  flex text-white justify-center p-1'>
                        <BsCloudSunFill />
                      </div>
                  </div>

                  <div className='font-semibold text-sm my-2 text-center'>Humanities</div>
                </div>
                </div>
              : <div className='flex flex-col items-center justify-center w-32 xs:w-36  2xs:w-40 md:w-52 lg:w-36 xl:w-48 h-36 bg-white shadow-2 rounded-lg'>
                <div className=' p-2 w-32 lg:w-fit '>
                  <div className=' bg-red p-2 w-fit rounded-full mx-auto bg-opacity-10'>
                    <div className='text-3xl  flex text-red justify-center p-1'>
                        <BsCloudSunFill />
                      </div>
                  </div>
          ...
          <Link to='/coursefinder?country=Where?&name=&discipline=environmental-science' state={{ slug: 'art' }} onMouseOver={() => setIsHovDiscipline17(true)} onMouseOut={() => setIsHovDiscipline17(false)}>
            {isHovDiscipline17
              ? <div className='flex flex-col items-center justify-center w-32 xs:w-36  2xs:w-40 border-2 border-border_white md:w-52 lg:w-36 xl:w-48 h-36 bg-white deepShadow rounded-lg'>
                <div className=' p-2 w-32 lg:w-fit '>
                  <div className=' bg-yellow p-2 w-fit rounded-full mx-auto'>
                  ...
                  <div className='font-semibold text-sm my-2 text-center'>Art</div>
                </div>
                </div>
              : <div className='flex flex-col items-center justify-center w-32 xs:w-36  2xs:w-40 md:w-52 lg:w-36 xl:w-48 h-36 bg-white shadow-2 rounded-lg'>
                <div className=' p-2 w-32 lg:w-fit '>
