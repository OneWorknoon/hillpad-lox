...
const  SalesAgentLogin = () => {
    React.useEffect(() => {
        document.title = "Sign In | hillPad -  Sales Agent Dashboard";
    ...
    return (
        <div className="w-[100vw]  font-sans font-thin relative sm:right-10 max-w-md p-8 bg-white rounded-lg shadow-md">
            ...
            <h4 className="text-center font-sans font-thin text-grey mb-8">Sign in to  Sales Agent's Dashboard</h4>
            ...
            <div className="mt-6">
                <p className="text-center text-sm text-grey">
                    Don't have an account? <Link to="/dashboard/sales/register" className=" text-orange hover:text-custom-600">SignUp</Link>
                </p>
            </div>
            <AuthIcon />
        </div>
...
export default  SalesAgentLogin;