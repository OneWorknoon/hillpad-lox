...
const  AccountOfficerRegister = () => {
  React.useEffect(() => {
    document.title = "Create an account | hillPad -  Account Officer Dashboard";
  ...
  return (
    <div className="w-[100vw] font-sans font-thin relative sm:right-10 max-w-md p-8 bg-white rounded-lg shadow-md">
      ...
      <h4 className="text-center font-sans font-thin text-grey  mb-8">Create an Hillpad Account Officer's account</h4>
      ...
      <div className="mt-6">
        <p className="text-center text-sm text-grey ">
          Already have an account? <Link to="/dashboard/account-officer/login" className="text-blue  hover:underline">Login</Link>
        </p>
      </div>
      <AuthIcon />
    </div>
...
export default  AccountOfficerRegister;